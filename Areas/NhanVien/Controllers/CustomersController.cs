...
namespace NewOne.Areas.NhanVien.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index(string searchString)
        {
            ...
            return View(customers.Where(x=>x.FullName.ToLower().Contains(searchString.ToLower())));
        }
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Account = new SelectList(model, "Username", "Username");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,FullName,Address,PhoneNumber,Point,Avatar,Username")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,FullName,Address,PhoneNumber,Point,Avatar,Username")] Customer customer)
        {
            if (ModelState.IsValid)
            {
                int check = 0;
