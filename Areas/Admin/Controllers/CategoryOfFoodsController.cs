...
namespace NewOne.Areas.Admin.Controllers
{
    public class CategoryOfFoodsController : Controller
    {
        ...
        public ActionResult Index(string searchString)
        {
            ...
            if (string.IsNullOrEmpty(searchString)) return View(categoryOfFoods);
            return View(categoryOfFoods.Where(x=>x.Name.ToLower().Contains(searchString)));
        }
