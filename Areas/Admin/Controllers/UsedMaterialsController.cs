...
namespace NewOne.Areas.Admin.Controllers
{
    public class UsedMaterialsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,IDFoodDetails,IDMaterial,Quantity")] UsedMaterial usedMaterial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,IDFoodDetails,IDMaterial,Quantity")] UsedMaterial usedMaterial)
        {
            if (ModelState.IsValid)
            {
